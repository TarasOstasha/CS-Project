...
export class PricingComponent implements OnInit {
  ...
  priceCard: any = {
      items: [
        ...
        { type: 'Hourly rate', cleaners: '1 cleaner - 40$/h', cleaners2: '2 cleaners - 80$/h', recommended_time: '3 h minimum' },
        { type: 'Extra services', extraService1: 'Refrigerator  $30', extraService2: 'Oven  $30', extraService3: 'Inside cabinets  $30', extraService4: 'Inside windows  $60', extraService5: 'Vacuum the sofa  $50',  rec_time: 'Laundry wash/dry  $30' }
